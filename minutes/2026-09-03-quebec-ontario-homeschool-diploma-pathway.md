# Minutes — Québec–Ontario Homeschool Diploma Pathway

**Parent information session, Dar Al-'Ulum Montréal**
...
Secondary 3 and 4 are done as homeschool plus the Ontario program, while the student is under 16 and still followed by the Direction de l'enseignement à la maison through its portal. At 16 the student is no longer eligible for that follow-up, so from Secondary 5 and Grade 12 onward the student is either followed directly by the school board or continues the full program described in this session. Exceptions apply where a student has repeated a year.

## 3. DES requirements (Québec, 54 credits)

Credits begin accumulating in Secondary 4 and 5; Secondary 3 carries no credits. The required units are French language of instruction Sec 5 (6), English second language Sec 5 (4), Mathematics Sec 4 (4), Science and Technology Sec 4 (4), History of Québec and Canada Sec 4 (4), Arts Sec 4 (2), CCQ/ethics (2), Physical Education Sec 5, Contemporary World (4), and Financial Education (2). A passing grade of 60% is required in every course.

## 4. What Dar Al-'Ulum teaches

**Secondary 4:** French, English second language, Mathematics SN, Science and Technology (ST + STE), History of Québec and Canada, Arts, Physical Education, CCQ. Arts, Physical Education and CCQ are deliberately placed in Secondary 4 to lighten Secondary 5. STE is taught rather than ATS because it is simpler to administer and matches the lab partner's setup.

**Secondary 5:** French, English second language, Mathematics SN, Physics, Chemistry, Contemporary World, Financial Education.

**Grade 12:** Credits are issued on the health science track by default, adjustable if the student targets another field.

## 5. Ministry exams and épreuves uniques

Each subject carries three to four competencies, and ministry exams do not evaluate all of them. History of Québec and Canada is the exception, evaluated in full by the ministry. In Mathematics Sec 4 two competencies are ministry-evaluated and one is not; in Science and Technology one competency is ministry-evaluated, with the remaining ST and STE competencies handled by épreuve unique or by a certified teacher. French Sec 5 and English Sec 5 are also ministry exams on selected competencies only.
...
## 9. Benefits of the pathway

Direct university entry is the headline: Concordia and McGill admit OSSD holders directly into their programs, while Université de Montréal and UQAM require one preparatory year before entry.

On grades, Dar Al-'Ulum as a homeschool support service cannot issue Québec marks, and the ministry only recognises marks entered by a school board; the school has no access to Charlemagne. Under the Ontario program marks accumulate continuously across the year, with report cards in December and June. For a homeschooled student on the Québec track alone, the only mark that appears in Secondary 4 is the ministry exam result, which means a full year of good work can be undone by one exam, and public school students with far more preparation resources also fail those exams.
...
A partnership has been secured with **GMC School**, the previous lab host having ceased operations. Secondary 3 students have 6 labs, roughly every six weeks; Secondary 4 and Secondary 5 have 10 each, roughly monthly. Sessions run Fridays, 8:00–9:00 AM, on designated weeks, with the full calendar to be shared once the school confirms.

The first session was scheduled for this Friday but GMC requested a reschedule by email the previous evening. It will instead be held **Wednesday 9 September, 8:30–9:30 AM**, covering all grades together; from then on each grade receives its own slot. Students will receive a lab booklet from GMC to track progress and submissions.
...
**What counts for the 40 hours of community involvement?** Ordinary volunteering, including service at the mosque, logged and recorded, spread across the four years in any distribution.

**Labs fall on a weekday, which makes pickup hard for working parents.** The previous host school is no longer operating, and GMC only has the lab free on Fridays, so there was no alternative. It is once a month, not weekly, and students return to Dar Al-'Ulum afterward with bus transport available.

**Can a student opt out of Mathematics SN?** Not at present. There is no CST stream, as the school is maintaining a single class rhythm. Students struggling with specific notions will be supported case by case.
...
**School / Mufti Zain:** write to CSSDM regarding the evaluation request and contact Mme Boivin directly; circulate the procedure and email template for the exam calendar after 30 September; share the full lab calendar once GMC confirms; post the Wednesday 9 September lab confirmation to the parents' group.

**Parents:** submit the projet d'apprentissage by 30 September; ensure students attend the first lab Wednesday 9 September, 8:30–9:30 AM, in Dar Al-'Ulum uniform; ensure the weekly scan-and-upload hour is used and portal submissions stay current; keep students attending all scheduled lab sessions.
